                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="box-header with-border">
                                <h3 class="box-title"><b>Riwayat Kerja</b> </h3>
                            </div><br>
                            <div class="col-md-6" style="margin-bottom: 10px">
                                <?php echo anchor(site_url('riwayat_kerja/create'),'<i class="fa fa-plus"></i> Tambah', 'class="btn btn-primary"'); ?>
                            </div><!-- 
                            ...
                            <div class="col-md-6 text-right">
                                <form action="<?php echo site_url('riwayat_kerja/index'); ?>" class="form-inline" method="get">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <?php 
                                                ...
                                                {
                                                    ?>
                                                    <a href="<?php echo site_url('riwayat_kerja'); ?>" class="btn btn-default">Reset</a>
                                                    <?php
                                                }
                                            ?>
                		...
                		<th>Action</th>
                			...
                			<td style="text-align:center" width="200px">
                				<?php 
                				echo anchor(site_url('riwayat_kerja/update/'.$riwayat_kerja->id_pekerjaan),'<i class="fa fa-edit"></i> Edit', 'class="btn-sm btn-warning"'); 
                				echo '  '; 
                				echo anchor(site_url('riwayat_kerja/delete/'.$riwayat_kerja->id_pekerjaan),'<i class="fa fa-trash"></i> Hapus', 'class="btn-sm btn-danger"','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                				?>
                			</td>
                		</tr>
                                <?php
