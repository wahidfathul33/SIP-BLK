<div class="row">
    <div class="col-12">
        <div class="card card-outline-info">
            ...
            <div class="card-body">
                <form class="m-t-40 floating-labels" action="<?php echo base_url()?>c_perusahaan/berita_add_act" method="post" enctype="multipart/form-data" novalidate>
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group m-b-40">
                            <div class="controls">   
                                <input name="header" type="text" class="form-control" id="judul"   required data-validation-required-message="Judul tidak boleh kosong" style="padding-left:5">
                                <span class="bar"></span>
                        ...
                        <div class="col-md-6 form-group m-b-40">
                            <div class="controls">
                                <input name="waktu_mulai" type="text" class="form-control" id="waktu_mulai" required data-validation-required-message="Waktu Mulai tidak boleh kosong" style="padding-left: 5px;">  
                                <span class="bar"></span>
                        ...
                        <div class="col-md-6 form-group m-b-40">
                            <div class="controls">
                                <input name="waktu_selesai" type="text" class="form-control" id="waktu_selesai" required data-validation-required-message="Waktu Selesai tidak boleh kosong" style="padding-left: 5px;">  
                                <span class="bar"></span>
                        ...
                        <div class="col-md-6 form-group m-b-40">
                            <div class="controls">
                                <input name="lokasi" type="text" class="form-control" id="lokasi" required data-validation-required-message="Lokasi tidak boleh kosong" style="padding-left: 5px;">  
                                <span class="bar"></span>
                        ...
                        <div class="col-md-6 form-group m-b-40">
                            <div class="controls">
                                <input name="maps_lokasi" type="text" class="form-control" id="maps_lokasi" style="padding-left: 5px;">  
                                <span class="bar"></span>
                        ...
                        <div class="col-12 form-group m-b-40">
                            ...
                            <div class="controls">
                               <input type="text" name="tanggal" class="form-control" id="datepicker-autoclose"  required data-validation-required-message="Tanggal tidak boleh kosong" placeholder="yyyy-mm-dd" style="padding-left:5px">
                                <span class="bar"></span>
                        ...
                        <div class="col-12 form-group m-b-40">
                            <div class="controls">
                                <textarea class="summernote" name="keterangan" required data-validation-required-message="Isi Berita tidak boleh kosong"><h4>Isi Berita <span class="text-danger">*</span></h4></textarea>
                            </div>
                        </div>
                        <div class="col-12 form-group m-b-40">
                            <h4 for="lampiran" style="padding: 4px;">Lampiran <span class="text-danger">* <?= $this->session->flashdata('lampiran');?></span></h4>
                            <div class="controls">
                                <input name="lampiran" type="file" id="lampiran" class="dropify"  required data-validation-required-message="Lampiran Perusahaan tidak boleh kosong"/>
