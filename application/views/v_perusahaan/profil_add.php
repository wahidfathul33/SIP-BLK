    ...
    <div class="col-12">
        ...
        <div class="card card-outline-info">
            <div class="card-body">
                ...
                <form class="floating-labels m-t-40" action="<?php echo base_url()?>c_perusahaan/profil_input_act" method="post" enctype="multipart/form-data" novalidate>
                <div class="row">
                    <div class="col-12">
                        <div class="form-group m-b-40">
                            <h4 for="logo" class="text-center" style="padding: 4px;">Logo Perusahaan</h4>
                            <div class="controls">
                                <input name="logo" type="file" id="logo" class="dropify"  required data-validation-required-message="Logo Perusahaan tidak boleh kosong"/>
                                <p class="text-center"><small>Upload logo *maks 1 MB</small></p>  
                    ...
                    <div class="col-md-6">
                        <div class="form-group m-b-40">
                            <div class="controls">
                                <input name="nama_perusahaan" type="text" class="form-control" id="nama_perusahaan" required data-validation-required-message="Nama Perusahaan tidak boleh kosong" style="padding-left: 5px;">  
                                <span class="bar"></span>
                        ...
                        <div class="form-group m-b-40">
                            <div class="controls">
                                <input name="email" type="email" class="form-control" id="email" required    data-validation-required-message="Email Perusahaan tidak boleh kosong" data-validation-email-message="Email tidak valid" style="padding-left: 5px;">  
                                <span class="bar"></span>
                        ...
                        <div class="form-group m-b-40">
                            ...
                            <div class="controls">
                                <select class = "form-control p-0 select2" id="skala" name="skala" style="width: 100%" required data-validation-required-message="Skala Perusahaan tidak boleh kosong">
                                    <?php for ($i=0; $i < count($skala) ; $i++) {?>
                                        <option value="<?= $skala[$i];?>"><?= $skala[$i]?></option>
                                    <?php }?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group m-b-40">
                            <div class="controls">
                                <input name="telpon" type="text" class="form-control" id="telpon" required    data-validation-required-message="Nomor Telpon Perusahaan tidak boleh kosong" style="padding-left: 5px;">  
                                <span class="bar"></span>
                        ...
                        <div class="form-group m-b-40">
                            <div class="controls">
                                <input name="website" type="text" class="form-control" id="website" required    data-validation-required-message="Website tidak boleh kosong" style="padding-left: 5px;">  
                                <span class="bar"></span>
                        ...
                        <div class="form-group m-b-40">
                            ...
                            <div class="controls">
                                <select class = "form-control p-0 select2" id="pemilikan" name="pemilikan" style="width: 100%"  required data-validation-required-message="Jenis Kepemilikan tidak boleh kosong">
                                    <?php for ($i=0; $i < count($pemilikan) ; $i++) {?>
                                        <option value="<?= $pemilikan[$i];?>"><?= $pemilikan[$i]?></option>
                                    <?php }?>
                                </select><span class="bar"></span>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group m-b-40">
                            <div class="controls">
                                <textarea class="form-control" rows="4" id="alamat" name="alamat" required    data-validation-required-message="Alamat Perusahaan tidak boleh kosong" style="padding-left: 5px;"></textarea>
                                <span class="bar"></span>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group m-b-40">
                            <div class="controls">
                                <textarea class="form-control" rows="4" id="deskripsi" name="deskripsi" required data-validation-required-message="Deskripsi Perusahaan tidak boleh kosong" style="padding-left: 5px;"></textarea>
                                <span class="bar"></span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group m-b-40">
                            <h4 for="npwp" class="text-center" style="padding: 4px;">SIUP</h4>
                            <div class="controls">
                                <input name="siup" type="file" id="siup" class="dropify"  required data-validation-required-message="SIUP tidak boleh kosong"/>
                                <p class="text-center"><small>Upload Scan SIUP *maks 1 MB</small></p> 
                    ...
                    <div class="col-md-6">
                        <div class="form-group m-b-40">
                            ...
                            <div class="controls">
                                <input name="npwp" type="file" id="npwp" class="dropify form-control" required data-validation-required-message="NPWP tidak boleh kosong"/>
                                <p class="text-center"><small>Upload Scan NPWP *maks 1 MB</small></p> 
