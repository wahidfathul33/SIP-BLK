...
<head>
    ...
    <title>SIP BLK Surakarta - Error 404</title>
    <!-- Bootstrap Core CSS -->
    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="<?php echo base_url();?>index" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back to home</a> </div>
